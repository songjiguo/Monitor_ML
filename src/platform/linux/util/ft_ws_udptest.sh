...
!udp.o, '1:10:200:/bind:0:%d/listen:255';\
!pfr.o, ;!initfs.o,a3:\
\
c0.o-llboot.o;\
...
\
udp.o-sm.o|print.o|fprr.o|mm.o|va.o|l.o|[from_]tnet.o|buf.o|bufp.o|eg.o|pfr.o;\
\
...
tif.o-sm.o|print.o|fprr.o|mm.o|l.o|va.o|eg.o|te.o|buf.o|bufp.o|pfr.o;\
