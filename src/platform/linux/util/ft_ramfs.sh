...
mm.o-print.o|[faulthndlr_]llboot.o;\
...
tp.o-sm.o|buf.o|print.o|va.o|te.o|fprr.o|mm.o|mpool.o;\
va.o-fprr.o|print.o|mm.o|l.o|boot.o;\
\
fi.o-sm.o|va.o|fprr.o|print.o|mm.o|te.o;\
\
rfs.o-sm.o|va.o|fprr.o|print.o|mm.o|buf.o|l.o|e.o|unique_map.o|pfr.o;\
unique_map.o-sm.o|va.o|fprr.o|print.o|mm.o|l.o|e.o|buf.o;\
ramfs_rec_test2.o-sm.o|va.o|fprr.o|print.o|mm.o|buf.o|l.o|rfs.o|e.o;\
ramfs_rec_test1.o-sm.o|va.o|fprr.o|print.o|mm.o|buf.o|l.o|rfs.o|e.o|ramfs_rec_test2.o|te.o|pfr.o\
" ./gen_client_stub
